---
description: LazyAgents · Add tests for a new feature.
---
...
2. **Use Memory for Context** — Search memory for existing testing patterns and prior edge cases: `lazyagents memory search --query "<feature testing strategy>"`.
...
7. **Store Reusable Knowledge** — Save reusable testing patterns or tricky fixtures with `lazyagents memory store ...`.

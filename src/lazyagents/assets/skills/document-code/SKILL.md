---
name: document-code
description: LazyAgents · Document a code entry point with structured analysis, dependency mapping, and saved knowledge docs. Use when users ask to document, understand, or map code for a module, file, folder, function, or API.
---
...
- Search for existing knowledge before analyzing: `lazyagents memory search --query "<entry point name or purpose>"`

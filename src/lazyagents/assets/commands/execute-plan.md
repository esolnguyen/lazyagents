---
description: LazyAgents · Execute a feature plan task by task.
---
...
2. **Use Memory for Context** — Search for prior implementation notes/patterns before starting: `lazyagents memory search --query "<feature implementation plan>"`.
...
6. **Store Reusable Knowledge** — Save reusable implementation guidance/decisions with `lazyagents memory store ...`.

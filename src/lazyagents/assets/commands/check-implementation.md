---
description: LazyAgents · Compare implementation with design and requirements docs to ensure alignment.
---
...
2. **Use Memory for Context** — Search memory for known constraints and prior decisions before assessing mismatches: `lazyagents memory search --query "<feature implementation alignment>"`.
...
5. **Store Reusable Knowledge** — Save recurring alignment lessons/patterns with `lazyagents memory store ...`.

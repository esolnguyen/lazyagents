---
description: LazyAgents · Update planning docs to reflect implementation progress.
---
...
2. **Use Memory for Context** — Search memory for prior decisions that affect priorities/scope: `lazyagents memory search --query "<feature planning updates>"`.
...
5. **Store Reusable Knowledge** — If new planning conventions or risk-handling rules emerge, store them with `lazyagents memory store ...`.

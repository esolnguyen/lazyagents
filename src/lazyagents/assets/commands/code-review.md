---
description: LazyAgents · Pre-push code review against design docs.
---
...
2. **Use Memory for Context** — Search memory for project review standards and recurring pitfalls: `lazyagents memory search --query "code review checklist project conventions"`.
...
7. **Store Reusable Knowledge** — Save durable review findings/checklists with `lazyagents memory store ...`.

...
- Before investigating, search for similar past incidents: `lazyagents memory search --query "<observed behavior> debug"`
...
- Store root cause and fix for future sessions: `lazyagents memory store --title "<root cause>" --content "<diagnosis and fix>" --tags "debug,root-cause"`

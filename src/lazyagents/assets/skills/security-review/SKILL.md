...
description: LazyAgents · Review code, skills, and prompts for security vulnerabilities — OWASP Top 10, prompt injection, business logic flaws, and insecure defaults. Use when reviewing PRs, auditing modules, reviewing AI skills/prompts, or preparing for release.
---
...
1. **Scope**
   ...
   - Search prior findings: `lazyagents memory search --query "<target> security"`
...
5. **Verify**
   ...
   - Store findings: `lazyagents memory store --title "<pattern>" --content "<finding and fix>" --tags "security,<category>"`

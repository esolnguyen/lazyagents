---
description: LazyAgents · Review feature design for completeness.
---
...
1. **Use Memory for Context** — Search memory for prior architecture constraints/patterns: `lazyagents memory search --query "<feature design architecture>"`.
2. Summarize:
...
4. **Store Reusable Knowledge** — Persist approved design patterns/constraints with `lazyagents memory store ...` when they will help future work.
